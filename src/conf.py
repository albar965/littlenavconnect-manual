...
exclude_patterns = ['SUMMARY.rst', 'README.rst']
...
html_logo = 'images/navconnect.svg'
html_favicon = 'images/navconnect.svg'
...
epub_publisher  = 'Alexander Barthel'
