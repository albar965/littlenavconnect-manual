...
for LANGNAME in "$@" ; do
  ...
  # Create A4 PDF
  ebook-convert deploy/littlenavconnect_book_${LANGNAME}.epub deploy/littlenavconnect_book_${LANGNAME}_a4.pdf --preserve-cover-aspect-ratio --paper-size a4 --base-font-size 9

  # Create US Letter PDF
  ebook-convert deploy/littlenavconnect_book_${LANGNAME}.epub deploy/littlenavconnect_book_${LANGNAME}_letter.pdf --preserve-cover-aspect-ratio --paper-size letter --base-font-size 9
